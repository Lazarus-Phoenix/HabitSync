...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'rest_framework_simplejwt' # Выдаёт токены текущих сессий
    'corsheaders', # Защита запросов между сервисами
    'drf_yasg', # Swager API интерактивная документация проекта
